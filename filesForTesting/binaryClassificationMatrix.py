...
# === PARAMETERS TO EDIT ===
model_path = 'CNNModels/model6.keras'        # Path to the .keras model
val_data_dir = 'savedDataForAllModels/dataForsign_language_model/trainOnThese/temporaryForConfusionMatrixA'  # The validation directory
